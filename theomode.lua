...
-- Make sure IsSpellReady is defined early so it's available for all functions
...
-- Global toggle for /theomode
QuickHeal_EnableTheomode = false

-- Slash command to call TheoMode logic
...
-- Slash command to toggle Theo Mode
...
local function Theo_UseUtilities()
    ...
    -- Trinket logic (Warmth of Forgiveness and Eye of the Dead)
    ...
    for slot = 13, 14 do -- Trinket slots
        ...
        if item then
            ...
            -- Eye of the Dead: 5+ raid members < 80% HP
...
Theo_UseUtilities()
    ...
    -- Cast Judgement of Wisdom combo if conditions are met
    local hasJudgement = QuickHeal_DetectBuff("player", "ability_paladin_judgementblue")
